...
import { Mail, Lock, Loader2, ArrowRight, Sparkles, X, Shield } from 'lucide-react';
    ...
    <AnimatePresence>
      {open && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            <div className="rounded-2xl border border-border/60 bg-background shadow-2xl shadow-black/40 p-8">
              {/* Close button */}
              <button
                onClick={onClose}
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <h2 className="text-xl font-display font-bold text-foreground mt-3">
                  {mode === 'signup' ? 'Create Account' : 'Login to Unlock Expert AI'}
                </h2>
                <p className="text-muted-foreground text-xs mt-1.5 text-center max-w-[280px]">
                  Join 1300+ A-Level &amp; University students on Econ Nexus. Secure &amp; Fast.
                </p>
              </div>
              ...
              <Button
                ...
                variant="outline"
                className="w-full mb-4 h-11 text-sm border-border/60 bg-muted/30 hover:bg-muted/50 text-foreground font-medium"
              >
              ...
              <form onSubmit={handleEmailAuth} className="space-y-3">
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    className="pl-10 h-10 bg-input/50 border-border/40"
                  />
                </div>
              ...
              <div className="mt-5 flex items-center justify-center gap-1.5 text-muted-foreground/60">
                ...
                <span className="text-[10px] tracking-wide">256-BIT ENCRYPTED · GDPR COMPLIANT</span>
              </div>
            </div>
          </motion.div>
        </div>
