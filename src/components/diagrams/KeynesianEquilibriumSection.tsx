          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors ${
              scenario === 'deflationary'
                ? 'bg-cambridge-magenta/30 text-cambridge-magenta border border-cambridge-magenta/50'
          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors ${
              scenario === 'inflationary'
                ? 'bg-cambridge-orange/30 text-cambridge-orange border border-cambridge-orange/50'
                : 'bg-muted/50 text-muted-foreground hover:bg-muted'
            }`}
          >
            Inflationary Gap
