...
const PositiveNormativeQuiz =  => {
 ...
 {percentage >= 80 
 ? "Excellent! You have a strong grasp of positive and normative distinctions.": percentage >= 50 
 ? "Good effort! Review the explanations to strengthen your understanding.": "Keep practicing! Focus on identifying value judgments vs. factual claims."}
 </p>
