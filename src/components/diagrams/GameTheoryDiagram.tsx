...
const GameTheoryDiagram =  => {
 ...
 hoveredCell === 'HH' 
 ? 'bg-green-500/20 border-green-400': 'bg-card/50 border-silver/20'
 }`}
 ...
 className={`relative p-4 rounded-xl border-2 transition-all cursor-pointer ${
 hoveredCell === 'HL' 
 ? 'bg-amber-500/20 border-amber-400': 'bg-card/50 border-silver/20'
 }`}
 variants={cellVariants}
 initial="hidden"
 animate={isVisible ? "visible": "hidden"}
 ...
 className={`relative p-4 rounded-xl border-2 transition-all cursor-pointer ${
 hoveredCell === 'LL' 
 ? 'bg-red-500/20 border-red-400': 'bg-card/50 border-silver/20'
 }`}
 variants={cellVariants}
 initial="hidden"
 animate={isVisible ? "visible": "hidden"}
