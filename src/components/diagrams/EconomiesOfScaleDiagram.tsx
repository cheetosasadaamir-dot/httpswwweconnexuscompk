...
const EconomiesOfScaleDiagram: React.FC =  => {
 ...
 activePhase === 'eos' 
 ? 'bg-emerald-500/20 border-emerald-500': 'bg-card/30 border-silver/10'
 }`}
 ...
 className={`p-4 rounded-lg border transition-all ${
 activePhase === 'crts' 
 ? 'bg-amber-500/20 border-amber-500': 'bg-card/30 border-silver/10'
 }`}
 whileHover={{ scale: 1.02 }}
 >
 ...
 className={`p-4 rounded-lg border transition-all ${
 activePhase === 'dos' 
 ? 'bg-red-500/20 border-red-500': 'bg-card/30 border-silver/10'
 }`}
 whileHover={{ scale: 1.02 }}
 >
