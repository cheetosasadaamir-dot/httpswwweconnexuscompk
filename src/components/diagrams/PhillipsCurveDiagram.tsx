...
const PhillipsCurveDiagram =  => {
 ...
 view === 'srpc' 
 ? 'bg-cambridge-cyan/30 text-cambridge-cyan': 'bg-muted/30 text-muted-foreground hover:bg-muted/50'
 }`}
 >
 Basic SRPC
 </button>
 ...
 className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors ${
 view === 'shift' 
 ? 'bg-cambridge-magenta/30 text-cambridge-magenta': 'bg-muted/30 text-muted-foreground hover:bg-muted/50'
 }`}
 >
 SRPC Shifts
 </button>
 ...
 className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors ${
 view === 'lrpc' 
 ? 'bg-cambridge-orange/30 text-cambridge-orange': 'bg-muted/30 text-muted-foreground hover:bg-muted/50'
 }`}
 >
 Long-Run (LRPC)
 </button>
