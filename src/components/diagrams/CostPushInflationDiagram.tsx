...
const CostPushInflationDiagram =  => {
 ...
 ? 'Rising production costs (wages, raw materials, oil) shift SRAS left from SRAS₁ to SRAS₂. This causes higher prices (P₁→P₂) AND lower output (Y₁→Y₂)—a situation called stagflation.': 'Click "Show AS Shift" to see how rising production costs cause the aggregate supply curve to shift left, leading to higher prices and lower real output.'}
 </p>
 </div>
 </div>
 );
