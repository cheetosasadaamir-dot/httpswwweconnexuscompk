...
const PPCShiftsDiagram = ({ type, title }: PPCShiftsDiagramProps) => {
 ...
 showShift 
 ? 'bg-cyan-500/20 text-cyan-400 border border-cyan-500/50': 'bg-muted/50 text-muted-foreground border border-muted hover:bg-primary/10'
 }`}
 >
 ...
 L ${margin.left + chartWidth * 0.5} ${margin.top + chartHeight * 0.2}`: `M ${margin.left + 15} ${margin.top + 40} 
