        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-flex items-center gap-3 mb-4">
              ...
              <span className="font-serif text-xl font-semibold text-silver-bright">Eco-Elite</span>
            </Link>
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              The premium destination for A-Level Economics mastery. 
        ...
        <div className="mt-12 pt-8 border-t border-silver/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="font-serif text-xs text-silver/50">
              © 2024 Eco-Elite. Crafted for future economists.
            </p>
