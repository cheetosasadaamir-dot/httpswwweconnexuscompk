  ...
  return (
    ...
    >
      <div className="w-full max-w-[1800px] mx-auto px-0 sm:px-4 md:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col lg:flex-row chatbot-container overflow-y-auto lg:overflow-hidden" style={{ height: 'calc(100dvh - 80px)', maxHeight: '1100px', WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain' }}>
