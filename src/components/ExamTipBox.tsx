...
const ExamTipBox = ({ 
 ...
 ? 'radial-gradient(circle, rgba(251, 191, 36, 0.4) 0%, transparent 70%)': variant === 'silver'
 ? 'radial-gradient(circle, rgba(203, 213, 225, 0.3) 0%, transparent 70%)': 'radial-gradient(circle, rgba(251, 146, 60, 0.4) 0%, transparent 70%)'
 }} 
 />
