...
const GlossarySection =  => {
 ...
 levelFilter === level
 ? 'bg-tutor-gold text-navy-deep': 'bg-navy-light text-muted-foreground hover:bg-navy-light/80 hover:text-silver-bright'
 )}
 >
 ...
 ? 'bg-tutor-gold text-navy-deep shadow-lg shadow-tutor-gold/20': hasTerms
 ? 'bg-navy-light text-silver hover:bg-tutor-gold/20 hover:text-tutor-gold': 'bg-navy-light/30 text-muted-foreground/30 cursor-not-allowed'
 )}
 >
 {letter}
 </button>
