...
const InteractivePPCEngine =  => {
 ...
 curveShift === 'growth'
 ? 'bg-green-500/20 border border-green-500/50 text-green-400 shadow-lg shadow-green-500/20': 'bg-space-elevated border border-border text-muted-foreground hover:text-foreground hover:border-green-500/30'
 }`}
 >
 ...
 ? 'bg-red-500/20 border border-red-500/50 text-red-400 shadow-lg shadow-red-500/20': 'bg-space-elevated border border-border text-muted-foreground hover:text-foreground hover:border-red-500/30'
 }`}
 >
 ...
 className={`flex items-center gap-2 px-4 py-2.5 rounded-lg transition-all ${
 showOpportunityCost
 ? 'bg-primary/20 border border-primary/50 text-primary shadow-lg shadow-primary/20': 'bg-space-elevated border border-border text-muted-foreground hover:text-foreground hover:border-primary/30'
 }`}
 >
