...
const FloatingDock =  => {
 ...
 isActive(child.href)
 ? "text-neon-cyan bg-neon-cyan/10 shadow-neon-cyan": "text-muted-foreground hover:text-white hover:bg-space-elevated"
 )}
 >
 {child.title}
 </Link>
 ...
 isActive(item.href)
 ? "text-neon-cyan bg-neon-cyan/10": "text-muted-foreground hover:text-white hover:bg-space-elevated/50"
 )}
 >
 {item.title}
 </Link>
