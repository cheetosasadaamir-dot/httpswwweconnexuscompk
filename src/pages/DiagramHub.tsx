...
/**
 * Econ Nexus Diagram Hub — 150 stage-by-stage economics diagrams.
...
const DiagramHub = () => {
  ...
  return (
    <div className="min-h-screen relative flex flex-col">
      <Helmet>
        <title>Diagram Hub — 150 Economics Diagrams | Econ Nexus</title>
        <meta
          name="description"
          content="Explore 150 complex economics diagrams explained stage by stage — micro and macro, from tax incidence to the GDP deflator."
        />
      </Helmet>
