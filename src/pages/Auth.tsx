...
const Auth =  => {
 ...
 {mode === 'signup'
 ? 'Sign up to access your economics dashboard': 'Sign in to continue your learning journey'}
 </p>
 </div>
 ...
 variant="outline"
 className="w-full mb-6 h-12 text-base border-border/50 hover:bg-accent/50"
 >
 ...
 {mode === 'login' && (
 <>
 <button onClick={ => setMode('magic')} className="text-sm text-primary hover:underline block w-full">
