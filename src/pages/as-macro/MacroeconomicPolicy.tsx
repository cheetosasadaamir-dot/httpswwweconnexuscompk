    ...
    <Layout showSidebar>
      ...
      >
        ...
        <ContentSection title="Fiscal Policy: The Budgetary Tool">
          ...
          <div className="glass-card p-5 space-y-4 mt-4">
            <h3 className="font-serif text-xl text-gradient">Critical Evaluation: Limitations of Fiscal Policy</h3>
        ...
        <ContentSection title="Monetary Policy: The Financial Tool">
          ...
          <div className="glass-card p-5 space-y-4 mt-4">
            <h3 className="font-serif text-xl text-gradient">Critical Evaluation: Limitations of Monetary Policy</h3>
        ...
        <ContentSection title="Supply-Side Policies: Expanding Productive Capacity">
          ...
          <div className="glass-card p-5 space-y-4 mt-4">
            <h3 className="font-serif text-xl text-gradient">Critical Evaluation: Supply-Side Policies</h3>
